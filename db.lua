local MissionData = {
	...
	["MissionModifiers"] = {
		...
		["Arbitrations"] = {
			Name = "Arbitrations",
			Link = "Arbitrations",
			LocationNote = "See alerts tab in in-game [[World State Window]], must complete all nodes on [[Star Chart]]"
		},
		["Archon Hunt"] = {
			Name = "Archon Hunt",
			Link = "Archon Hunt",
		...
		["The Steel Path"] = {
			Name = "The Steel Path",
			Link = "The Steel Path",
			LocationNote = "Must complete all nodes on [[Star Chart]] to toggle The Steel Path difficulty"
		},
 	...
 	["MissionDetails"] = {
		...
		{ Name = "Fortuna", Link = "Fortuna", Planet = "Venus", Type = "Hub", Quotes = "Fortuna/Quotes", Tileset = "Fortuna", Enemy = "Tenno", MinLevel = 0, MaxLevel = 0, MasteryExp = 0, InternalName = "SolarisUnitedHub1", Introduced = "24", NextNodes = { "Orb Vallis" }, PreviousNodes = { "Unda" }, CreditReward = 0 },
		...
		{ Name = "Aphrodite", Link = "Aphrodite", Planet = "Venus", Type = "Mobile Defense", Quotes = "Mobile Defense/Quotes", Tileset = "Corpus Outpost", Enemy = "Corpus", MinLevel = 6, MaxLevel = 8, MasteryExp = 18, InternalName = "SolNode2", NextNodes = { "Fossa", "Mercury Junction" }, PreviousNodes = { "Kiliken", "Venera" }, IsTracked = true },
		{ Name = "Cytherean", Link = "Cytherean", Planet = "Venus", Type = "Interception", Quotes = "Interception/Quotes", Tileset = "Corpus Ship", Enemy = "Corpus", MinLevel = 3, MaxLevel = 8, DropTableAlias = "Interception1", MasteryExp = 18, InternalName = "SolNode23", PreviousNodes = { "Kiliken" }, IsTracked = true },
		{ Name = "E Gate", Link = "E Gate", Planet = "Venus", Type = "Exterminate", Quotes = "Exterminate/Quotes", Tileset = "Corpus Outpost", Enemy = "Corpus", MinLevel = 3, MaxLevel = 5, MasteryExp = 18, InternalName = "SolNode128", NextNodes = { "Tessera", "Unda", "V Prime" }, PreviousNodes = { "Venus Junction" }, IsTracked = true, CreditsReward = 1200 },
		...
		{ Name = "Kiliken", Link = "Kiliken", Planet = "Venus", Type = "Excavation", Quotes = "Excavation/Quotes", Tileset = "Corpus Outpost", Enemy = "Corpus", MinLevel = 3, MaxLevel = 8, DropTableAlias = "Excavation1", MasteryExp = 18, InternalName = "SolNode101", NextNodes = { "Aphrodite", "Cytherean" }, PreviousNodes = { "Unda" }, IsTracked = true },
		...
		{ Name = "Romula", Link = "Romula", Planet = "Venus", Type = "Defense", Quotes = "Defense/Quotes", IsDarkSector = true, Tileset = "Corpus Outpost", Enemy = "Infested", MinLevel = 8, MaxLevel = 18, DropTableAlias = "DSDefense", AdditionalCreditReward = 10000, DSResourceBonus = 0.1, DSXPBonus = 0.1, DSWeaponBonus = 0.05, DSWeapon = "Rifles", MasteryExp = 0, InternalName = "ClanNode0", Introduced = "13", PreviousNodes = { "V Prime" }, IsTracked = true },
		...
		{ Name = "Unda", Link = "Unda", Planet = "Venus", Type = "Spy", Quotes = "Spy/Quotes", Tileset = "Corpus Outpost", Enemy = "Corpus", MinLevel = 4, MaxLevel = 6, DropTableAlias = "Spy1", MasteryExp = 18, InternalName = "SolNode66", NextNodes = { "Fortuna", "Kiliken", "Venera" }, PreviousNodes = { "E Gate" }, IsTracked = true },
		...
		{ Name = "V Prime", Link = "V Prime", Planet = "Venus", Type = "Survival", Quotes = "Survival/Quotes", Tileset = "Corpus Ship", Enemy = "Corpus", MinLevel = 3, MaxLevel = 8, DropTableAlias = "Survival1", MasteryExp = 18, InternalName = "SolNode123", NextNodes = { "Romula" }, PreviousNodes = { "E Gate" }, IsTracked = true },
		{ Name = "Fossa", Link = "Fossa", Planet = "Venus", Type = "Assassination", Quotes = "Jackal/Quotes", Tileset = "Corpus Ship", Enemy = "Corpus", MinLevel = 6, MaxLevel = 8, DropTableAlias = "Jackal",  Boss = "Jackal", Pic = "Jackal_sigil_b.png", Drops = {"Rhino"}, MasteryExp = 41, InternalName = "SolNode104", PreviousNodes = { "Aphrodite" }, IsTracked = true },
		{ Name = "Mercury Junction", Planet = "Venus", Type = "Solar Rail Junction", Quotes = "Junction/Quotes", Tileset = "Solar Rail", Enemy = "Tenno", MinLevel = 1, MaxLevel = 3, Link = "Junction", MasteryExp = 1000, InternalName = "VenusToMercuryJunction", Introduced = "Specters of the Rail 0.0", NextNodes = { "M Prime", "Pantheon", "Larunda Relay" }, PreviousNodes = { "Aphrodite" }, IsTracked = true, CreditReward = 0 },
		
		{ Name = "Cetus", Link = "Cetus", Planet = "Earth", Type = "Hub", Quotes = "Cetus/Quotes", Tileset = "Cetus", Enemy = "Tenno", MinLevel = 0, MaxLevel = 0, MasteryExp = 0, InternalName = "CetusHub4", Introduced = "22", NextNodes = { "Plains of Eidolon" }, PreviousNodes = { "Mantle" }, CreditReward = 0 },
		{ Name = "Plains of Eidolon", Link = "Plains of Eidolon", Image = "Plains of Eidolon.png", Planet = "Earth", Type = "Free Roam", Quotes = "Plains of Eidolon/Quotes", Tileset = "Plains of Eidolon", Enemy = "Grineer", MinLevel = 10, MaxLevel = 30, DropTableAlias = "Landscape", Pic = "DawnsEarlyLight.png", MasteryExp = 24, InternalName = "SolNode228", Introduced = "22", NextNodes = { "Eurasia", "Everest" }, PreviousNodes = { "Cetus" }, IsTracked = true, CreditReward = 0 },
		{ Name = "Cambria", Link = "Cambria", Planet = "Earth", Type = "Spy", Quotes = "Spy/Quotes", Tileset = "Grineer Forest", Enemy = "Grineer", MinLevel = 2, MaxLevel = 4, DropTableAlias = "Spy1", MasteryExp = 24, InternalName = "SolNode79", NextNodes = { "Venus Junction" }, PreviousNodes = { "Gaia", "Lith" }, IsTracked = true },
		...
		{ Name = "Eurasia", Link = "Eurasia", Planet = "Earth", Type = "Mobile Defense", Quotes = "Mobile Defense/Quotes", Tileset = "Grineer Forest", Enemy = "Grineer", MinLevel = 3, MaxLevel = 5, MasteryExp = 24, InternalName = "SolNode59", NextNodes = { "Mars Junction" }, PreviousNodes = { "Plains of Eidolon" }, IsTracked = true },
		...
		{ Name = "Mantle", Link = "Mantle", Planet = "Earth", Type = "Capture", Quotes = "Capture/Quotes", Tileset = "Grineer Forest", Enemy = "Grineer", MinLevel = 2, MaxLevel = 4, DropTableAlias = "Capture", MasteryExp = 24, InternalName = "SolNode63", NextNodes = { "Cetus", "Gaia", "Lith" }, PreviousNodes = { "Mariana" }, IsTracked = true, CreditsReward = 1100 },
		...
		{ Name = "Mars Junction", Planet = "Earth", Type = "Solar Rail Junction", Quotes = "Junction/Quotes", Tileset = "Solar Rail", Enemy = "Tenno", MinLevel = 1, MaxLevel = 1, Link = "Junction", MasteryExp = 1000, InternalName = "EarthToMarsJunction", Introduced = "Specters of the Rail 0.0", NextNodes = { "Hellas", "Strata Relay" }, PreviousNodes = { "Eurasia" }, IsTracked = true, CreditReward = 0 },
		...
		{ Name = "Ara", Link = "Ara", Planet = "Mars", Type = "Capture", Quotes = "Capture/Quotes", Tileset = "Grineer Settlement", Enemy = "Grineer", MinLevel = 10, MaxLevel = 12, DropTableAlias = "Capture", MasteryExp = 51, InternalName = "SolNode45", NextNodes = { "Alator", "Syrtis" }, PreviousNodes = { "Ares" }, IsTracked = true, CreditsReward = 1900 },
		{ Name = "Ares", Link = "Ares", Planet = "Mars", Type = "Sabotage", Quotes = "Sabotage/Quotes", Tileset = "Grineer Settlement", Enemy = "Grineer", MinLevel = 9, MaxLevel = 11, MasteryExp = 51, InternalName = "SolNode113", NextNodes = { "Ara", "Augustus", "Martialis" }, PreviousNodes = { "Spear" }, IsTracked = true },
		{ Name = "Arval", Link = "Arval", Planet = "Mars", Type = "Spy", Quotes = "Spy/Quotes", Tileset = "Grineer Settlement", Enemy = "Grineer", MinLevel = 9, MaxLevel = 11, DropTableAlias = "Spy1", MasteryExp = 51, InternalName = "SolNode41", PreviousNodes = { "Spear" }, IsTracked = true },
		{ Name = "Augustus", Link = "Augustus", Planet = "Mars", Type = "Excavation", Quotes = "Excavation/Quotes", Tileset = "Grineer Settlement", Enemy = "Grineer", MinLevel = 9, MaxLevel = 14, DropTableAlias = "Excavation1", MasteryExp = 51, InternalName = "SolNode16", NextNodes = { "Gradivus", "Olympus", "Tyana Pass" }, PreviousNodes = { "Ares" }, IsTracked = true },
		{ Name = "Gradivus", Link = "Gradivus", Planet = "Mars", Type = "Sabotage", Quotes = "Sabotage/Quotes", Tileset = "Corpus Ship", Enemy = "Corpus", MinLevel = 9, MaxLevel = 11, CacheDropTableAlias = "Reactor1", MasteryExp = 45, InternalName = "SolNode65", NextNodes = { "Phobos Junction" }, PreviousNodes = { "Augustus", "Tharsis" }, IsTracked = true },
		{ Name = "Hellas", Link = "Hellas", Planet = "Mars", Type = "Exterminate", Quotes = "Exterminate/Quotes", Tileset = "Grineer Settlement", Enemy = "Grineer", MinLevel = 8, MaxLevel = 10, MasteryExp = 51, InternalName = "SolNode58", NextNodes = { "Spear", "Tharsis" }, PreviousNodes = { "Mars Junction" }, IsTracked = true },
		{ Name = "Kadesh", Link = "Kadesh", Planet = "Mars", Type = "Defense", Quotes = "Defense/Quotes", IsDarkSector = true, Tileset = "Grineer Settlement", Enemy = "Infested", MinLevel = 10, MaxLevel = 20, DropTableAlias = "DSDefense", AdditionalCreditReward = 14000, DSResourceBonus = 0.2, DSXPBonus = 0.15, DSWeaponBonus = 0.1, DSWeapon = "Pistols", MasteryExp = 0, InternalName = "ClanNode8", Introduced = "13", NextNodes = { "Horend" }, PreviousNodes = { "War" }, IsTracked = true },
		{ Name = "Martialis", Link = "Martialis", Planet = "Mars", Type = "Rescue", Quotes = "Rescue/Quotes", Tileset = "Grineer Settlement", Enemy = "Grineer", MinLevel = 10, MaxLevel = 12, DropTableAlias = "Rescue1", MasteryExp = 51, InternalName = "SolNode36", NextNodes = { "Ceres Junction", "Vallis", "War" }, PreviousNodes = { "Ares" }, IsTracked = true },
		...
		{ Name = "Spear", Link = "Spear", Planet = "Mars", Type = "Defense", Quotes = "Defense/Quotes", Tileset = "Grineer Settlement", Enemy = "Grineer", MinLevel = 8, MaxLevel = 13, DropTableAlias = "Defense1", Other = "B", MasteryExp = 51, InternalName = "SolNode46", NextNodes = { "Ares", "Arval" }, PreviousNodes = { "Hellas" }, IsTracked = true },
		...
		{ Name = "Tharsis", Link = "Tharsis", Planet = "Mars", Type = "Mobile Defense", Quotes = "Mobile Defense/Quotes", Tileset = "Grineer Settlement", Enemy = "Grineer", MinLevel = 8, MaxLevel = 10, MasteryExp = 51, InternalName = "SolNode11", NextNodes = { "Gradivus", "Maroo's Bazaar" }, PreviousNodes = { "Hellas" }, IsTracked = true },
		{ Name = "Tyana Pass", Link = "Tyana Pass", Planet = "Mars", Type = "Mirror Defense", Quotes = "Mirror Defense/Quotes", Tileset = "Grineer Settlement", Enemy = "Grineer and Corpus", MinLevel = 25, MaxLevel = 30, DropTableAlias = "MirrorDefense", MasteryExp = 18, InternalName = "SolNode450", PreviousNodes = { "Augustus" }, IsHidden = true, IsTracked = true, Requirements = "Must have [[Heart of Deimos]] completed to access", Introduced = "32.3" },
		...
		{ Name = "War", Link = "War (Node)", Planet = "Mars", Type = "Assassination", Quotes = "Lieutenant Lech Kril/Quotes", Tileset = "Grineer Settlement", Enemy = "Grineer", MinLevel = 11, MaxLevel = 13, DropTableAlias = "Lech Kril", Boss = "Lieutenant Lech Kril", Pic = "LechKril_sigil_b.png", Drops = {"Excalibur"}, MasteryExp = 51, InternalName = "SolNode99", NextNodes = { "Kadesh" }, PreviousNodes = { "Martialis" }, IsTracked = true },
		...
		{ Name = "Horend", Link = "Horend", Planet = "Deimos", Type = "Capture", Quotes = "Capture/Quotes",  Tileset = "Orokin Derelict", Enemy = "Infested", MinLevel = 12, MaxLevel = 14, DropTableAlias = "Capture", MasteryExp = 0, InternalName = "SolNode706", Introduced = "29", NextNodes = { "Phlegyas" }, PreviousNodes = { "Kadesh" }, IsTracked = true, CreditsReward = 2100 },
		...
		{ Name = "Ludi", Link = "Ludi", Planet = "Ceres", Type = "Hijack", Quotes = "Hijack/Quotes", Tileset = "Grineer Shipyard", Enemy = "Grineer", MinLevel = 15, MaxLevel = 17, MasteryExp = 163, InternalName = "SolNode138", NextNodes = { "Jupiter Junction" }, PreviousNodes = { "Exta", "Ker", "Lex" }, IsTracked = true },
		...
		{ Name = "Jupiter Junction", Planet = "Ceres", Type = "Solar Rail Junction", Quotes = "Junction/Quotes", Tileset = "Solar Rail", Enemy = "Tenno", MinLevel = 1, MaxLevel = 3, Link = "Junction", MasteryExp = 1000, InternalName = "CeresToJupiterJunction", Introduced = "Specters of the Rail 0.0", NextNodes = { "Metis" }, PreviousNodes = { "Ludi" }, IsTracked = true, CreditReward = 0 },
		...
		{ Name = "Metis", Link = "Metis", Planet = "Jupiter", Type = "Rescue", Quotes = "Rescue/Quotes", Tileset = "Corpus Gas City", Enemy = "Corpus", MinLevel = 15, MaxLevel = 17, DropTableAlias = "Rescue2", MasteryExp = 51, InternalName = "SolNode126", NextNodes = { "Ananke", "Carme", "Elara" }, PreviousNodes = { "Jupiter Junction" }, IsTracked = true },
		...
		{ Name = "Archaeo-freighter", Link = "Archaeo-freighter", Planet = "Europa", Type = "Survival", Quotes = "Survival/Quotes", Tileset = "Corpus Ice Planet", Enemy = "Corpus", MinLevel = 25, MaxLevel = 30, MasteryExp = 0, InternalName = "", Introduced = "26", IsHidden = true, Requirements = "Must have [[Grendel Neuroptics Locator]] to access" },
		{ Name = "Icefields of Riddah", Link = "Icefields of Riddah", Planet = "Europa", Type = "Defense", Quotes = "Defense/Quotes", Tileset = "Corpus Ice Planet", Enemy = "Corpus", MinLevel = 25, MaxLevel = 30, MasteryExp = 0, InternalName = "", Introduced = "26", IsHidden = true, Requirements = "Must have [[Grendel Chassis Locator]] to access" },
		{ Name = "Mines of Karishh", Link = "Mines of Karishh", Planet = "Europa", Type = "Excavation", Quotes = "Excavation/Quotes", Tileset = "Corpus Ice Planet", Enemy = "Corpus", MinLevel = 25, MaxLevel = 30, MasteryExp = 0, InternalName = "", Introduced = "26", IsHidden = true, Requirements = "Must have [[Grendel Systems Locator]] to access" },
		
		{ Name = "Anthe", Link = "Anthe", Planet = "Saturn", Type = "Rescue", Quotes = "Rescue/Quotes", Tileset = "Grineer Galleon", Enemy = "Grineer", MinLevel = 22, MaxLevel = 24, DropTableAlias = "Rescue3", MasteryExp = 55, InternalName = "SolNode31", NextNodes = { "Rhea" }, PreviousNodes = { "Telesto" }, IsTracked = true },
		{ Name = "Calypso", Link = "Calypso", Planet = "Saturn", Type = "Sabotage", Quotes = "Sabotage/Quotes", Tileset = "Grineer Galleon", Enemy = "Grineer", MinLevel = 24, MaxLevel = 26, CacheDropTableAlias = "Reactor2", MasteryExp = 55, InternalName = "SolNode82", NextNodes = { "Tethys" }, PreviousNodes = { "Keeler" }, IsTracked = true },
		...
		{ Name = "Dione", Link = "Dione", Planet = "Saturn", Type = "Spy", Quotes = "Spy/Quotes", Tileset = "Grineer Asteroid", Enemy = "Grineer", MinLevel = 21, MaxLevel = 23, DropTableAlias = "Spy2", MasteryExp = 55, InternalName = "SolNode67", NextNodes = { "Telesto" }, PreviousNodes = { "Saturn Junction" }, IsTracked = true },
		...
		{ Name = "Piscinas", Link = "Piscinas", Planet = "Saturn", Type = "Survival", Quotes = "Survival/Quotes", IsDarkSector = true, Tileset = "Grineer Asteroid", Enemy = "Infested", MinLevel = 26, MaxLevel = 36, DropTableAlias = "DSSurvival2", AdditionalCreditReward = 14000, DSResourceBonus = 0.2, DSXPBonus = 0.15, DSWeaponBonus = 0.1, DSWeapon = "Shotguns", MasteryExp = 0, InternalName = "ClanNode13", Introduced = "13", PreviousNodes = { "Rhea" }, IsTracked = true },
		...
		{ Name = "Telesto", Link = "Telesto", Planet = "Saturn", Type = "Exterminate", Quotes = "Exterminate/Quotes", Tileset = "Grineer Galleon", Enemy = "Grineer", MinLevel = 22, MaxLevel = 24, MasteryExp = 55, InternalName = "SolNode20", NextNodes = { "Anthe", "Keeler" }, PreviousNodes = { "Dione" }, IsTracked = true },
		...
		{ Name = "Ariel", Link = "Ariel", Planet = "Uranus", Type = "Capture", Quotes = "Capture/Quotes", Tileset = "Grineer Sealab", Enemy = "Grineer", MinLevel = 25, MaxLevel = 27, DropTableAlias = "Capture", MasteryExp = 69, InternalName = "SolNode33", NextNodes = { "Ophelia" }, PreviousNodes = { "Sycorax" }, IsTracked = true, CreditsReward = 3400 },
		...
		{ Name = "Caliban", Link = "Caliban (Node)", Planet = "Uranus", Type = "Rescue", Quotes = "Rescue/Quotes", Tileset = "Grineer Sealab", Enemy = "Grineer", MinLevel = 25, MaxLevel = 27, DropTableAlias = "Rescue3", MasteryExp = 69, InternalName = "SolNode60", NextNodes = { "Umbriel" }, PreviousNodes = { "Sycorax" }, IsTracked = true },
		{ Name = "Cressida", Link = "Cressida", Planet = "Uranus", Type = "Mobile Defense", Quotes = "Mobile Defense/Quotes", Tileset = "Grineer Sealab", Enemy = "Grineer", MinLevel = 27, MaxLevel = 29, MasteryExp = 69, InternalName = "SolNode83", NextNodes = { "Caelus", "Titania", "Ur" }, PreviousNodes = { "Ophelia" }, IsTracked = true },
		{ Name = "Desdemona", Link = "Desdemona", Planet = "Uranus", Type = "Sabotage", Quotes = "Sabotage/Quotes", Tileset = "Grineer Sealab", Enemy = "Grineer", MinLevel = 26, MaxLevel = 28, CacheDropTableAlias = "SealabCaches", MasteryExp = 69, InternalName = "SolNode98", NextNodes = { "Rosalind", "Brutus" }, PreviousNodes = { "Stephano" }, IsTracked = true },
		...
		{ Name = "Ophelia", Link = "Ophelia", Planet = "Uranus", Type = "Survival", Quotes = "Survival/Quotes", Tileset = "Grineer Sealab", Enemy = "Grineer", MinLevel = 24, MaxLevel = 29, DropTableAlias = "Survival3", MasteryExp = 69, InternalName = "SolNode69", NextNodes = { "Cressida" }, PreviousNodes = { "Ariel" }, IsTracked = true },
		{ Name = "Puck", Link = "Puck", Planet = "Uranus", Type = "Exterminate", Quotes = "Exterminate/Quotes", Tileset = "Grineer Sealab", Enemy = "Grineer", MinLevel = 27, MaxLevel = 29, MasteryExp = 44, InternalName = "SolNode114", NextNodes = { "Assur", "Titania" }, PreviousNodes = { "Umbriel" }, IsTracked = true },
		...
		{ Name = "Stephano", Link = "Stephano", Planet = "Uranus", Type = "Defense", Quotes = "Defense/Quotes", Tileset = "Grineer Sealab", Enemy = "Grineer", MinLevel = 24, MaxLevel = 29, DropTableAlias = "Defense3", Other = "O", MasteryExp = 69, InternalName = "SolNode122", NextNodes = { "Desdemona" }, PreviousNodes = { "Sycorax" }, IsTracked = true },
		{ Name = "Sycorax", Link = "Sycorax", Planet = "Uranus", Type = "Exterminate", Quotes = "Exterminate/Quotes", Tileset = "Grineer Sealab", Enemy = "Grineer", MinLevel = 24, MaxLevel = 26, MasteryExp = 69, InternalName = "SolNode34", NextNodes = { "Ariel", "Caliban", "Stephano" }, PreviousNodes = { "Uranus Junction" }, IsTracked = true },
		{ Name = "Umbriel", Link = "Umbriel", Planet = "Uranus", Type = "Interception", Quotes = "Interception/Quotes", Tileset = "Grineer Sealab", Enemy = "Grineer", MinLevel = 24, MaxLevel = 29, DropTableAlias = "Interception2", MasteryExp = 69, InternalName = "SolNode64", NextNodes = { "Puck" }, PreviousNodes = { "Caliban" }, IsTracked = true },
		...
		{ Name = "Sao", Link = "Sao", Planet = "Neptune", Type = "Sabotage", Quotes = "Sabotage/Quotes", Tileset = "Corpus Outpost", Enemy = "Corpus", MinLevel = 29, MaxLevel = 31, MasteryExp = 52, InternalName = "SolNode57", NextNodes = { "Laomedeia", "Proteus" }, PreviousNodes = { "Despina" }, IsTracked = true },
		...
		{ Name = "Sedna Junction", Planet = "Pluto", Type = "Solar Rail Junction", Quotes = "Junction/Quotes", Tileset = "Solar Rail", Enemy = "Tenno", MinLevel = 1, MaxLevel = 1, Link = "Junction", MasteryExp = 1000, InternalName = "PlutoToSednaJunction", Introduced = "Specters of the Rail 0.0", NextNodes = { "Naga" }, PreviousNodes = { "Regna" }, IsTracked = true, CreditReward = 0 },
...
NonInternalNames = {"","ToggleBootLevel"}

OutString = '{\n'
for _, mission in pairs(MissionData['MissionDetails']) do
	InternalNameFound = false
	for _,value in pairs(NonInternalNames) do
		if string.match(value, mission.InternalName) then
			InternalNameFound = true
		end
	end
	if InternalNameFound then
		OutString = OutString .. '\t' .. '"'.. mission.Name .. '": ' .. '{\n'
	else
		OutString = OutString .. '\t' .. '"'.. mission.InternalName .. '": ' .. '{\n'
	end
	for missionKey, missionValue in pairs(mission) do
		...
		if type(missionValue) == "boolean" then
			...
			OutString = OutString .. '\t\t"' .. missionKey .. '": "' .. BooleanValuePlaceholder .. '",\n'
		-- If the value is a table, iterate through the table and add each value to the string
		elseif type(missionValue) == "table" then
			OutString = OutString .. '\t\t"' .. missionKey .. '": ['
			for _, listedValue in ipairs(missionValue) do
				OutString = OutString .. '"' .. listedValue .. '"' .. ','
			end
			-- remove last comma unless it is a empty array
			if #missionValue > 0 then
				OutString = OutString:sub(1, -2) -- remove last comma
			end
			OutString = OutString .. "],\n"
		-- If the value is a string, add it to the string as is
		else
			NewLineIndex = string.find(missionValue, "\n")
			if NewLineIndex then
				OutString = OutString .. '\t\t"' .. missionKey .. '": ' .. '['
				for i in string.gmatch(missionValue, "[^\n]+") do
					-- print the substring
				...
				OutString = OutString .. '\t\t"' .. missionKey .. '": "' .. missionValue .. '",\n'
			end
		end
	end
	OutString = OutString:sub(1, -3) -- remove last comma and newline
	OutString = OutString .. '\n'
	OutString = OutString .. '\t},\n'
end
OutString = OutString:sub(1, -3) -- remove last comma and newline
OutString = OutString .. '\n}\n'
print(OutString) -- for testing purposes only